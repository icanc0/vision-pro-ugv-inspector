...
//=============================================================================
//
// ladybugPanoStitch.cpp
// 
// This  shows users how to extract an image set from a Ladybug camera,
// stitch it together and write the final stitched image to disk.
//
// Since Ladybug library version 1.3.alpha.01, this is modified to use
...
#pragma warning(pop)
    ...
    while (true)
    {
        ...
        const std::string outputPath = getWriteableDirectory() + std::string("PanoStitchOutput.jpg");
